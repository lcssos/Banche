...
//    private Integer bancheId;
    ...
    private String cheliangUpdatetime;
    ...
    public void setCheliangChepai(String cheliangChepai) {
        this.cheliangChepai = cheliangChepai == null ? null : cheliangChepai.trim();
    }
    ...
    public void setCheliangChexing(String cheliangChexing) {
        this.cheliangChexing = cheliangChexing == null ? null : cheliangChexing.trim();
    }
    ...
    public void setCheliangJiashiyuan(String cheliangJiashiyuan) {
        this.cheliangJiashiyuan = cheliangJiashiyuan == null ? null : cheliangJiashiyuan.trim();
    }
    ...
    public void setCheliangTele(String cheliangTele) {
        this.cheliangTele = cheliangTele == null ? null : cheliangTele.trim();
    }
    ...
    public void setCheliangWangfantime(String cheliangWangfantime) {
        this.cheliangWangfantime = cheliangWangfantime == null ? null : cheliangWangfantime.trim();
    }
    ...
    public String getCheliangUpdatetime() {
        return cheliangUpdatetime;
    }

    public void setCheliangUpdatetime(String cheliangUpdatetime) {
        this.cheliangUpdatetime = cheliangUpdatetime == null ? null : cheliangUpdatetime.trim();
    }
}