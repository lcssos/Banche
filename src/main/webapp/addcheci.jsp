...
<div class="admin">
    ...
    <div class="easyui-layout" style="width:100%;height:350px;">
        <div data-options="region:'west',split:true" style="width:200px;"><table id="grid_checi"></table></div>
        <div data-options="region:'center',iconCls:'icon-ok'">
            <table class="easyui-datagrid" id="grid_zc"
                   data-options="url:'getzhandiancheci.action',method:'get',border:false,singleSelect:true,fit:true,fitColumns:true,onEndEdit:function(index,row,changes){
                ...
                <tr>
                    ...
                    <th data-options="field:'zhandianDizhi',formatter:function(value,row,index){return row.zhandian.zhandianDizhi}" width="300">地址</th>
                    <th data-options="field:'zhandianYuji',editor:'text'" width="100">预计到达时间</th>
                </tr>
                </thead>
            </table>
        </div>
